  ...
  return (
    <div className="bg-white">
      <div>
        ...
        <main className="mx-auto lg:px-8  px-4 sm:px-6 ">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              <div>
                <div className='flex justify-between items-center py-10'>
                  <h1 className='text-lg text-black opacity-50 font-bold'>Filters</h1>
                          ...
                          <FormControl>
                            ...
                            >
                              {section.options.map((option, optionIdx) => (
                                ...
                                <>
                                  <FormControlLabel value={option.value} control={<Radio />} label={option.label} onChange={(e)=>handleRadioFilterChange(e,section.id)}/>
